  ...
  createConfig () {
    return new Promise((resolve, reject) => {
      ...
      try {
        ...
        config.elasticsearch.host = `${backendPath}${config.elasticsearch.host}`
        config.orders.endpoint = `${backendPath}${config.orders.endpoint}`
        config.products.endpoint = `${backendPath}${config.products.endpoint}`
        config.users.loginAfterCreatePassword = true
        for (let [key, value] of Object.entries(config.users)) {
          if (key.endsWith('endpoint') && typeof value !== 'object') {
            config.users[`${key}`] = `${backendPath}${value}`
          }
        }
        config.stock.endpoint = `${backendPath}${config.stock.endpoint}`
        for (let [key, value] of Object.entries(config.cart)) {
          if (key.endsWith('endpoint') && typeof value !== 'object') {
            config.cart[`${key}`] = `${backendPath}${value}`
          }
        }
        config.reviews.create_endpoint = `${backendPath}${config.reviews.create_endpoint}`

        config.newsletter.endpoint = `${backendPath}${config.newsletter.endpoint}`
        config.mailer.endpoint.send = `${backendPath}${config.mailer.endpoint.send}`
        config.mailer.endpoint.token = `${backendPath}${config.mailer.endpoint.token}`
        config.images.baseUrl = this.answers.images_endpoint
        config.cms.endpoint = `${backendPath}${config.cms.endpoint}`
        config.cms.endpointIdentifier = `${backendPath}${config.cms.endpointIdentifier}`
        ...
        if (this.answers.ssr_endpoints) {
          ...
          config.elasticsearch.host_ssr = `${backendPath}${config.elasticsearch.host}`
          config.orders.endpoint_ssr = `${backendPath}${config.orders.endpoint}`
          config.products.endpoint_ssr = `${backendPath}${config.products.endpoint}`
          config.users.endpoint_ssr = `${backendPath}${config.users.endpoint}`
          config.users.history_endpoint_ssr = `${backendPath}${config.users.history_endpoint}`
          config.users.resetPassword_endpoint_ssr = `${backendPath}${config.users.resetPassword_endpoint}`
          config.users.changePassword_endpoint_ssr = `${backendPath}${config.users.changePassword_endpoint}`
          config.users.login_endpoint_ssr = `${backendPath}${config.users.login_endpoint}`
          config.users.create_endpoint_ssr = `${backendPath}${config.users.create_endpoint}`
          config.users.me_endpoint_ssr = `${backendPath}${config.users.me_endpoint}`
          config.users.refresh_endpoint_ssr = `${backendPath}${config.users.refresh_endpoint}`
          config.stock.endpoint_ssr = `${backendPath}${config.stock.endpoint}`
          config.cart.create_endpoint_ssr = `${backendPath}${config.cart.create_endpoint}`
          config.cart.updateitem_endpoint_ssr = `${backendPath}${config.cart.updateitem_endpoint}`
          config.cart.deleteitem_endpoint_ssr = `${backendPath}${config.cart.deleteitem_endpoint}`
          config.cart.pull_endpoint_ssr = `${backendPath}${config.cart.pull_endpoint}`
          config.cart.totals_endpoint_ssr = `${backendPath}${config.cart.totals_endpoint}`
          config.cart.paymentmethods_endpoint_ssr = `${backendPath}${config.cart.paymentmethods_endpoint}`
          config.cart.shippingmethods_endpoint_ssr = `${backendPath}${config.cart.shippingmethods_endpoint}`
          config.cart.shippinginfo_endpoint_ssr = `${backendPath}${config.cart.shippinginfo_endpoint}`
          config.cart.collecttotals_endpoint_ssr = `${backendPath}${config.cart.collecttotals_endpoint}`
          config.cart.deletecoupon_endpoint_ssr = `${backendPath}${config.cart.deletecoupon_endpoint}`
          config.cart.applycoupon_endpoint_ssr = `${backendPath}${config.cart.applycoupon_endpoint}`
          config.reviews.create_endpoint_ssr = `${backendPath}${config.reviews.create_endpoint}`

          // Probably pointless (only CS)
          // config.newsletter.endpoint_ssr = `${backendPath}/api/ext/mailchimp-subscribe/subscribe`
          config.mailer.endpoint.send_ssr = `${backendPath}${config.mailer.endpoint.send}`
          config.mailer.endpoint.token_ssr = `${backendPath}${config.mailer.endpoint.token}`
          // Probably pointless (only CS)
          // config.images.baseUrl_ssr = this.answers.images_endpoint
          config.cms.endpoint_ssr = `${backendPath}${config.cms.endpoint}`
          config.cms.endpointIdentifier_ssr = `${backendPath}${config.cms.endpointIdentifier}`
        }
